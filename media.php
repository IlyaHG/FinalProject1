...
if(has_avatar($_SESSION['user']['id']) || $user['avatar'] = ''){
    $avatar_check = false;
}


var_dump($avatar_check);
?>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <?php if($avatar_check): ?>
                                    <img src="avatars/<?php echo $user['avatar']; ?>" alt="" class="img-responsive" width="200">
                                    <?php else: ?>
                                    <img src="img/avatar_default/avatar-m.png" alt="" class="img-responsive" width="200">
                                    <?php endif; ?>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="example-fileinput">Выберите аватар</label>
                                    <input type="hidden" name = "userid" id ="singleinput" value="<?=$_GET['userid'];?>">
