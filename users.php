                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <span class="status status-<?php echo $user['status'];?> mr-3">
                                    <span class="rounded-circle profile-image d-block "  style="background-image:url('/avatars/<?php echo $user['avatar']?>'); background-size: cover;"> </span>
                                </span>
                                ...
                                <div class="info-card-text flex-1">                                    
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo $user['name'];?>     
                                        <?php if(is_admin(get_authenticated_user()) ||
                                         is_equal($user,get_authenticated_user())): ?>                                                        
                                    ...
                                    <a class="dropdown-item" href="page_profile.php?userid=<?= $user['id'];?>">
                                            <i class="fa fa-smile"></i>
                                        Профиль</a>
                                        <a class="dropdown-item" href="edit.php?userid=<?= $user['id'];?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="security.php?userid=<?= $user['id'];?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="status.php?userid=<?= $user['id'];?>">
                                        <input type="hidden" name="userid" id="simpleinput" class = "form-control"  value ="<?=$_SESSION['user'];?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="media.php?userid=<?= $user['id'];?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="delete_user.php?userid=<?= $user['id'];?>" class="dropdown-item" >
                                            <i class="fa fa-window-close"onclick="return confirm('are you sure?');"></i>
                                            Удалить
                                        </a>
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $user['work_place'];?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $user['phone_number'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
