...
$user_mail = transfer_the_mail($userid);

$id_user = select_last_id();
                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="/avatars/<?php echo $user['avatar'];?>" class="rounded-circle shadow-2 img-thumbnail"  alt="">
                            ...
                            <div class="col-12">
                                <div class="p-3 text-center">
                                    ...
                                    <a href="mailto:<?php echo $user_mail?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mouse-pointer text-muted mr-2"></i><?php echo $user_mail; ?> </a>
                                    <address class="fs-sm fw-400 mt-4 text-muted">
                                        <i class="fas fa-map-pin mr-2"></i> <?php echo $user['address']; ?>
                                    </address>
                                    <div class="col-md-7 mt-3 d-flex flex-row-reverse">
                                        <a href="edit.php?userid=<?= $id;?>">
