                        ...
                        <?php display_flash_message('danger'); ?>
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="newpass" id="simpleinput" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="newpass2" id="simpleinput" class="form-control">
                                </div>
