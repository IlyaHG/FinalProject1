...
$admin = is_admin(get_authenticated_user());
if (!$admin) {
    redirect_to("page_login.php");
}
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <?php display_flash_message("null_email"); ?>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="work_place">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="emailfor">
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                <label class="form-label" for="example-fileinput">Загрузить аватар, файл не превышающий 2МБ</label>
